...
2.VSCode 需要安装 ESLint 插件： 3.解决 eslint 和 prettier 冲突的问题：
...
Tip: 创建项目时已经选择了 eslint+prettier，eslint 已经暂时配置好了，只要重启一下 VScode 即可
...
这里会做三件事： 1.安装 husky 相关的依赖： 2.在项目目录下创建 `.husky` 文件夹：
